...
<<<<<<< HEAD
Restaurant.create(name: "All American Burger" , address: "4286 Merrick Rd, Massapequa, NY 11758", restaurant_type: "American Grille", restaurant_owner_id: RestaurantOwner.all.sample.id, menu_url: "https://www.allamericanhamburgerli.com/menu", image_url: "https://images.app.goo.gl/7ud2vA4X5vgooG5u7", hours_of_operation: "11 AM - 8 PM M-Sunday")
Restaurant.create(name: "Ginza", address: "45 Carmans Rd, Massapequa, NY 11758", restaurant_type: "Japanese", restaurant_owner_id: RestaurantOwner.all.sample.id, menu_url: "https://www.ginzali.com/menu", image_url: "https://images.app.goo.gl/gVnKQpeUyCp3ePbP8", hours_of_operation: "Temporarily Closed")
Restaurant.create(name: "Thom Thom", address: "3340 Park Ave, Wantagh, NY 11793", restaurant_type: "Sushi/Steakhouse", restaurant_owner_id: RestaurantOwner.all.sample.id, menu_url: "https://www.thomthomrestaurant.com/menu", image_url: "https://images.app.goo.gl/B4X8S1FsLTNQVb8B6", hours_of_operation: "4 PM - 11 PM M-Saturday, 3 PM - 8 PM Sunday")
...
Restaurant.create(name: "Nagahama", address: "169 E Park Ave, Long Beach, NY 11561", restaurant_type: "Sushi", restaurant_owner_id: RestaurantOwner.all.sample.id, menu_url: "http://www.nagahamasushi.com/menus.html", image_url: "https://images.app.goo.gl/uMBnf7WjEB9yTc2Y7", hours_of_operation: "4 PM - 11 PM")
Restaurant.create(name: "Peter's Clam Bar", address: "600 Long Beach Rd, Island Park, NY 11558", restaurant_type: "Seafood", restaurant_owner_id: RestaurantOwner.all.sample.id, menu_url: "https://www.petersclamhouse.com/menu/restaurant-menu/", image_url: "https://images.app.goo.gl/ULijMmUrfvhAxFY28", hours_of_operation: "11 AM - 11 PM")
Restaurant.create(name: "Mio Posto", address: "16 Merrick Ave, Merrick NY 11566", restaurant_type: "Italian", restaurant_owner_id: RestaurantOwner.all.sample.id, menu_url: nil, image_url: nil, hours_of_operation: "5 PM - 10 PM")
Restaurant.create(name: "Gyro Palace", address: "1694 Sunrise Highway, Merrick, NY 11566", restaurant_type: "Greek", restaurant_owner_id: RestaurantOwner.all.sample.id, menu_url: "https://www.gyropalacemerrick.com/categories?menu=1", image_url: nil, hours_of_operation: "11 PM - 9 PM")
Restaurant.create(name: "Kyma", address: "1446 Old Northern Blvd, Roslyn, NY 11576", restaurant_type: "Greek", restaurant_owner_id: RestaurantOwner.all.sample.id, menu_url: "https://kyma-roslyn.com/wp-content/uploads/2020/05/KYMA-to-go-Menu-6.pdf", image_url: nil, hours_of_operation: "1130 AM - 10 PM")
Restaurant.create(name: "Cipollini", address: "2110 Northern Blvd, Manhasset, NY 11030", restaurant_type: "Italian", restaurant_owner_id: RestaurantOwner.all.sample.id, menu_url: "https://www.pollrestaurants.com/media//cms/Cipollini_Dinner_1.pdf", image_url: nil, hours_of_operation: "12 PM - 11 PM")
...
>>>>>>> 7bbc9223c95ecbdefc28498b93082cc19634eefe
